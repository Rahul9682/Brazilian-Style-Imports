//  SearchItemsByCategory.swift
//  QuickB2B Wholesale
//  Created by Sazid Saifi on 07/06/23.

import Foundation

struct SearchItemsByCategory: Codable {
    
    var status: Int?
    var show_price: String?
    var message: String?
//    var data: [SearchItemsByCategoryData]?
    var data: [GetItemsData]?
    var displayAllItems:Bool?
...
struct SearchItemsByCategoryData: Codable {
